...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
       ...
       File file = new File("D:\\programering\\file\\testFileName.txt");
        ...
        try {
            FileWriter myFileWriter = new FileWriter("D:\\programering\\file\\testFileName.txt");
            myFileWriter.write("""
                    190
                    168
                    166
        ...
        try {
            ...
            while((line = reader.readLine()) !=null){
                ...
                if(values > prevMeas ){
                    System.out.println(values + " (increased)");
                    larger++;
                    prevMeas = values;
                }else {
       ...
       Scanner myReader = new Scanner(file);
        ...
        kollar  filen finns, vart den ligger, det går att skriva i den, går att läsa den
       if(file.exists()){
